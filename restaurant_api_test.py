...
try:
    ...
    try:
        ...
        url = address + "/restaurants/%s?name=Udacity&address=2465+Latham+Street+Mountain+View+CA&image=https://media" \
                        ".glassdoor.com/l/70/82/fc/e8/students-first.jpg" % restID
        h = httplib2.Http()
